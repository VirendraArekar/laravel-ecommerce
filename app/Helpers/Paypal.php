...
class PayPal
{
    ...
    public function gateway()
    {
        ...
        $gateway->setUsername(config('pay.paypal.username'));
        $gateway->setPassword(config('pay.paypal.password'));
        $gateway->setSignature(config('pay.paypal.signature'));
        $gateway->setTestMode(config('pay.paypal.sandbox'));
